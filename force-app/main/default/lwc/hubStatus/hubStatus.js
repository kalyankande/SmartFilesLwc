...
import inactiveBikes from '@salesforce/apex/statusCheck.inactiveBikes';
import currentBookings from '@salesforce/apex/statusCheck.currentBookings';
import duetoService from '@salesforce/apex/statusCheck.duetoService';

export default class StatusCheck extends LightningElement {
    @api recordId;
   ...
   ICBikes({data,error}){
    if(data){
        ...
        this.val1=(this.total_inactiveBikes/this.totalBikes1)*100;
   ...
   CBooks({data,error}){
    if(data){
        ...
        this.val2=(this.total_bookedBikes/this.totalBikes2)*100;
   ...
   @wire(duetoService,{hubid:'$recordId'})
   MainBikes({data,error}){
    if(data){
        ...
        this.val3=(this.total_servicebikes/this.totalBikes3)*100;
